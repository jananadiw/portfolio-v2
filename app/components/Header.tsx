...
export default function Header() {
  ...
  return (
    <div className="lg:sticky lg:top-0 lg:flex lg:max-h-screen lg:w-1/2 lg:flex-col lg:justify-between lg:py-24">
      <div>
        <h1
          className={`text-4xl sm:text-3xl lg:text-4xl text-red-400/80 ${noto_serif.className}`}
        >
          Hi, I&apos;m Jananadi
        </h1>
        <p
          className={`mt-4 max-w-xs leading-normal text-test1 text-xl ${inter.className}`}
        >
